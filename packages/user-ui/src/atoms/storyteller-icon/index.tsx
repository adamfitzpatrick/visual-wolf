...
export function Storyteller(props: StorytellerProps) {
  ...
  return (
    ...
    >
      ...
      <g id='sky'>
        <rect x='0' y='0' width='75' height='85' fill='url(#sky-gradient)' stroke='none' />
      </g>

      <g id='sun'>
        <circle cx='70' cy='60' r='12' fill='rgb(255, 253, 73)' stroke='none' />
      </g>

      <g id='water'>
        <path d='M 0,115 h 75 v 50 h -75 v -50'
          fill='url(#water-gradient)'
          stroke='none'
        />
        <ellipse cx='15' cy='140' rx='7' ry='0.5' fill='rgb(255, 255, 255)' stroke='none' />
        <ellipse cx='30' cy='133' rx='5' ry='0.5' fill='rgb(255, 255, 255)' stroke='none' />
        <ellipse cx='55' cy='143' rx='9' ry='0.5' fill='rgb(255, 255, 255)' stroke='none' />
        <ellipse cx='49' cy='138' rx='3' ry='0.3' fill='rgb(255, 255, 255)' stroke='none' />
      </g>

      <g id='land3-a'>
        <path d='M 0,80 l 15,-30 c 5,-10 8,-10 13,0 l 18,36 l -20,10 h -26'
      ...
      <g id='land3-b'>
        <path d='M 42,95 l 15,-30 c 5,-10 8,-10 13,0 l 18,36 l -20,10 h -26'
          fill='url(#land3-gradient)'
          stroke='none'
        />
        <path d='M 57,65 c 5,-10 8,-10 13,0 h -13'
          ...
          stroke='none'
        />
        <path d='M 57,64.9 l -5,10 l 7,-10 l 2,6 l 2,-6 l 4,10 l 1,-10 l 5.9,8 l -3.5,-8'
          fill='url(#snow-gradient)'
          stroke='none'
        />
      </g>
      ...
      <g id='land2'>
        <path d='M 0,90 c 30,10 40,-25 75,-3 v 23 h -75'
      ...
      <g id='land1'>
        <path d='M 0,116 h 75 v-10 c -40,8 -50,-15 -75,-3'
