    ...
    return (
        <svg
            ...
            <g
                ...
                <path
                    style={{ fill: "none", stroke: "#2763ff", strokeWidth: 1.07, strokeLinejoin: "bevel", strokeMiterlimit: 3.5 }}
                    d="M 26.12,57.64 c 8.91,1.96 16.04,1.96 24.94,0"
                />
                <path
                    style={{ fill: "none", stroke: "#2763ff", strokeWidth: 0.89, strokeLinejoin: "miter", strokeMiterlimit: 3.5 }}
                ...
                />
                <path
                    style={{ fill: "#2763ff", stroke: "#2763ff", strokeWidth: 1.07, strokeLinejoin: "miter", strokeMiterlimit: 3.5 }}
                ...
                <circle
                    ...
                    r="2.22" />
                <path
                    style={{ fill: "none", stroke: "#2763ff", strokeWidth: 0.71, strokeLinejoin: "miter", strokeMiterlimit: 3.5 }}
            ...
            <g
                ...
                style={{ transformOrigin: 'center' }}>
                <path
                    style={{ fill: "none", stroke: "#2763ff", strokeWidth: 1.78, strokeLinejoin: "bevel", strokeMiterlimit: 3.5 }}
                    d="M 12.09,19.14 c 0.62,1.25 2.49,3.92 5.35,4.63 v 13.72 c -2.85,0.71 -4.72,2.94 -5.35,4.45 -7.13,-5.70 -7.13,-17.46 0,-22.81 z"
                    id="path122" />
                <path
                    style={{ fill: "none", stroke: "#2763ff", strokeWidth: 1.78171, strokeLinejoin: "miter", strokeMiterlimit: 3.5 }}
                    ...
                    id="path123" />
                <path
                    style={{ fill: "#2763ff", stroke: "none", strokeWidth: 0.63, strokeMiterlimit: 3.5 }}
                ...
                <path
                    ...
                    id="rect88" />
                <path
                    style={{ fill: "#2763ff", stroke: "none", strokeWidth: 0.89, strokeLinejoin: "miter", strokeMiterlimit: 3.5 }}
                ...
                <path
                    ...
                    id="path103" />
                <path
                    style={{ fill: "none", stroke: "#2763ff", strokeWidth: 1.78, strokeLinejoin: "miter", strokeMiterlimit: 3.5 }}
                    ...
                    id="path107" />
                <path
                    style={{ fill: "none", stroke: "#2763ff", strokeWidth: 1.43 }}
